...
def download_advice_pdf(detailid, filename, access_token):
    ...
    # Provide a Streamlit download link
...
def connectips_page():
    ...
    # Make sure to initialize bank_code and bank_acc_no
    bank_code = None
    bank_acc_no = None
    ...
    if st.session_state['logged_in']:
        # Display bank selection and date input fields
        bank_name = st.selectbox("Select Bank", options=list(bank_details.keys()))
        
        # Assign values to bank_code and bank_acc_no based on selection
        if bank_name:
        ...
        # Button to login to the bank and check balance
        ...
        # Button to fetch pending approvals
        ...
        # Display pending approvals and approval buttons
        ...
        # Button to fetch details of approved payments
        if st.session_state['bank_balance_fetched']:
        ...
        # Display details and download buttons
...
def main():
    with st.sidebar:
        selected = option_menu(
            "Main Menu", ["ConnectIPS", "Other Page"],
            icons=['house', 'gear'],
